Shader "Jaytt/PostRendering/OutLine/With Noise/Normals based"
{
	...
	#include "UnityCG.cginc"
		...
		sampler2D _Replace, _MainTex, _CameraDepthTexture, _CameraDepthNormalsTexture,_Noise,_Noise2;
	...
	fixed4 frag(v2f i) : SV_Target
	{
		...
		half4 Replace = getReplace(i.screenuv);
